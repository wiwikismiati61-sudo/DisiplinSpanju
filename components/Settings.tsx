...
const Settings: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newCredentials = {
            ...
            password: formState.newPassword || credentials.password
        };
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md space-y-6 max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    ...
                    <input
                        ...
                        className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-brand-secondary focus:border-brand-secondary"
                        required
                    />
                </div>
                <div>
                ...
                <div className="flex justify-end">
                    <button
                        type="submit"
                        className="flex items-center bg-brand-primary hover:bg-brand-dark text-white font-bold py-2 px-4 rounded-lg transition duration-300"
                    >
